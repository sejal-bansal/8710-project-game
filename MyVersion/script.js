window.addEventListener("DOMContentLoaded", function() {
 ...
 // https://www.cleanpng.com/free/halloween,4.html
  ...
  //selecting pause button
  const pause= document.getElementById("btnPause");
  //selecting resume button
  const restart = document.getElementById("btnResume");
...
//code from https://www.youtube.com/watch?v=29D4DWfZzI0
  btnPause.onclick = ()=>{
    clearInterval(time);
  }
